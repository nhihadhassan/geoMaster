        ...
        {mobileDetailsOpen && !autoHide ? (
          ...
          >
            <div className="sticky top-0 z-10 flex items-center justify-between gap-3 border-b border-white/10 bg-zinc-950/88 px-3 py-3 backdrop-blur-2xl">
              <div className="min-w-0">
                <p className="text-[0.6rem] font-semibold uppercase tracking-[0.22em] text-emerald-100/58">
                  Country details
                </p>
              ...
              <button
                ...
                className="min-h-10 rounded-full border border-white/12 bg-white/8 px-4 text-xs font-semibold text-white/70 transition hover:bg-white/14 hover:text-white"
              >
                Close
              </button>
            </div>
