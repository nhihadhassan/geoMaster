...
export function CountryPopup({
  ...
  return (
    <motion.aside
      ...
      className="pointer-events-none absolute inset-x-4 bottom-28 z-30 mx-auto w-[min(31rem,calc(100vw-2rem))] overflow-hidden rounded-3xl border border-emerald-100/22 bg-black/56 shadow-2xl shadow-emerald-950/40 backdrop-blur-2xl"
    >
